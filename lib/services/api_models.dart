...
class FeedContent {
  ...
  factory FeedContent.fromJson(Map<String, dynamic> json) {
    ...
    return FeedContent(
      ...
      category:
          category is Map ? category['name']?.toString() ?? 'Geral' : 'Geral',
...
class ForumTopic {
  ...
  factory ForumTopic.fromJson(Map<String, dynamic> json) {
    ...
    return ForumTopic(
      ...
      excerpt:
          json['body']?.toString() ?? json['excerpt']?.toString() ?? '',
      category:
          category is Map ? category['name']?.toString() ?? 'Geral' : 'Geral',
      author: author is Map
          ? author['name']?.toString() ?? 'Comunidade'
          : 'Comunidade',
...
// Kept for any legacy callers — delegates to QuizModel.fromJson
QuizModel quizFromJson(Map<String, dynamic> json) => QuizModel.fromJson(json);
